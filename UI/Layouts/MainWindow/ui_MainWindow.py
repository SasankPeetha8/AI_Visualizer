...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.GameRegion.setEnabled(True)
        ...
        self.ManualLineInput.setInputMethodHints(Qt.ImhNone)
        ...
        sizePolicy5.setHeightForWidth(self.AIMoveFrame.sizePolicy().hasHeightForWidth())
        self.AIMoveFrame.setSizePolicy(sizePolicy5)
        ...
        sizePolicy1.setHeightForWidth(self.AITypeBox.sizePolicy().hasHeightForWidth())
        self.AITypeBox.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.IterationsCheckBox.sizePolicy().hasHeightForWidth())
        self.IterationsCheckBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.TimeCheckBox.sizePolicy().hasHeightForWidth())
        self.TimeCheckBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.EnableReUseCheckBox.sizePolicy().hasHeightForWidth())
        self.EnableReUseCheckBox.setSizePolicy(sizePolicy6)
        self.EnableReUseCheckBox.setChecked(True)
        ...
        sizePolicy1.setHeightForWidth(self.LimitsFrame.sizePolicy().hasHeightForWidth())
        self.LimitsFrame.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.L_LimitButton.sizePolicy().hasHeightForWidth())
        self.L_LimitButton.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.M_LimitButton.sizePolicy().hasHeightForWidth())
        self.M_LimitButton.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.H_LimitButton.sizePolicy().hasHeightForWidth())
        self.H_LimitButton.setSizePolicy(sizePolicy6)

        self.horizontalLayout_5.addWidget(self.H_LimitButton)

        self.HighestLimit = QPushButton(self.LimitsFrame)
        self.HighestLimit.setObjectName(u"HighestLimit")
        sizePolicy6.setHeightForWidth(self.HighestLimit.sizePolicy().hasHeightForWidth())
        self.HighestLimit.setSizePolicy(sizePolicy6)

        self.horizontalLayout_5.addWidget(self.HighestLimit)
        ...
        self.AIDisplayTreeButton.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.AIMoveButton.sizePolicy().hasHeightForWidth())
